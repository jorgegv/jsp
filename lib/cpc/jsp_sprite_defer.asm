...
;;     uint8_t yrot = sp->ypos & 7, xrot = sp->xpos & 7;
...
mark_footprint:
	...
	;; (no extra bottom row when cell-aligned, see lib/cpc/jsp_frame.asm), so
	;; render-cells and dirtied-cells agree and the aligned case marks no spurious row.
	ld c,(ix+0)			; C = rows

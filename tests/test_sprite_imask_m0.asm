...
;; CPC Mode 0 sprite '_test_sprite_imask_m0_pixels' (sprite_imask)
;; source assets/ball.png region (0,0) 16x16 px -> 8 Mode-0 cols x 2 rows (+extra bottom row)
;; _test_sprite_imask_m0_pixels: 192 body bytes (cs=8, 2 px/cell)
	...
	db	$00
	db	$00
PUBLIC _test_sprite_imask_m0_pixels
_test_sprite_imask_m0_pixels:
